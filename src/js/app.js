...
function render(variables = {}) {
  ...
  if (variables.name == null) nombre = "Name";
  let apellido = variables.lastName;
  if (variables.lastName == null) apellido = "Last name";
  let work = `<h2>${variables.role}</h2>`;
  if (variables.role == null) work = "<h2> </h2>";
  let ciudad = variables.city;
  if (variables.city == null) ciudad = " ";
  let pais = variables.country;
  if (variables.country == null) pais = " ";
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class="${pos}">
            ...
            <li><a href="https://linkedin.com/school/${linked}"><i class="fab fa-linkedin"></i></a></li>
